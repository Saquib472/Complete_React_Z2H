const VideoTitle = ({title , overview}) => {
  return (
    <div className="pt-36 md:pt-0 aspect-video absolute  bg-gradient-to-r from-black z-10 flex flex-col justify-center">
        <div className="md:w-5/12 px-10 text-white">
